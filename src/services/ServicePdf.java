...
para.add("Entete du fichier PDF");
 addHeader(writer);
             ...
             List<Tournoi> liste_admins = sa.affichTournoi();
...
for (i = 0; i < liste_admins.size(); i++) {
    ...
    table.addCell(String.valueOf(liste_admins.get(i).getNbrc()));
     String imageFile = "../Federation-de-football-master (1)/Federation-de-football-master/public/uploads/" +liste_admins.get(i).getLogo();
